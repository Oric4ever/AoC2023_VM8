...
To give an idea of the performance, the calculation of fibonacci(42) using the following function takes 4 hours 44 minutes 52 seconds. This means that the Advent of Code puzzles have to be solved with algorithms that avoid brute force approaches...
